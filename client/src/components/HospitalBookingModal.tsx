...
export default function HospitalBookingModal({ hospital, isOpen, onClose }: Props) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error('Error booking hospital appointment:', err);
    }
            ...
            >
              ...
              {submitted ? (
                ...
                >
                  ...
                  <div>
                    <h2 className="text-2xl font-extrabold text-dark-navy mt-2">Appointment Requested! 🎉</h2>
                    <p className="text-text-grey text-sm mt-2 max-w-sm mx-auto leading-relaxed">
                      Your booking request with <strong className="text-dark-navy">{hospital.name}</strong> ({form.department} Department) on{' '}
                    ...
                    <p className="text-xs text-text-grey mt-3">
                      Our consultant will contact you shortly on <strong>{form.mobile}</strong> to finalize and confirm your slot.
                    </p>
                  </div>
                ...
                <>
                  ...
                  <div className="flex-shrink-0 px-5 pt-6 pb-4 border-b border-slate-100 bg-gradient-to-r from-soft-green/60 to-light-mint/40">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="relative flex-shrink-0">
                        <div className="w-16 h-16 rounded-2xl overflow-hidden border-2 border-white shadow-md bg-slate-100">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <h3 className="font-extrabold text-dark-navy text-base leading-tight">{hospital.name}</h3>
                        <p className="text-xs text-text-grey font-medium mt-1.5 flex items-center gap-1">
                  ...
                  >
                    ...
                    {/* Section: Hospital Departments & Doctor Selection */}
                    <div>
                      <h4 className="text-xs font-bold text-dark-navy uppercase tracking-wide mb-3 flex items-center gap-1.5">
                        <Building2 className="w-3.5 h-3.5 text-primary-green" />
                        Select Department & Specialist
                      </h4>
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        {/* Department */}
                        <div>
                        ...
                        <div>
                          <label className="block text-[11px] font-bold text-text-grey mb-1">
                            Preferred Doctor <span className="text-[9px] font-bold text-slate-400">(Optional)</span>
                          </label>
                          <div className="relative">
                            ...
                            <select
                              ...
                              className="w-full pl-9 pr-8 py-2.5 rounded-xl border bg-slate-50 text-sm text-dark-navy focus:outline-none focus:bg-white focus:ring-2 transition-all appearance-none border-slate-200 focus:border-primary-green focus:ring-primary-green/10"
                            >
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-text-grey mb-2.5">
                        Attach previous test results, prescriptions, or X-rays to help the doctors prepare. Accepted: JPG, PNG, PDF · Max {MAX_FILES} files.
                      </p>

...
export default function HospitalPromotePage() {
  ...
  const fetchPromotions = async () => {
    try {
      ...
      const currentPromo = data.find((item: any) => item.id === MOCK_HOSPITAL.id);
      if (currentPromo) {
  ...
  const handleCancel = async () => {
    ...
    try {
      const res = await fetch(`${process.env.NEXT_PUBLIC_SITE_URL}/api/promote`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ action: 'cancel', id: MOCK_HOSPITAL.id })
      });
  ...
  return (
    <div className="flex min-h-screen" style={{ background: 'var(--bg-app)' }}>
      <PanelSidebar role="hospital" userName={MOCK_HOSPITAL.name} />
              ...
              <div className="panel-card p-6 border-amber-400/20 bg-gradient-to-br from-amber-400/5 to-transparent relative overflow-hidden">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                  <div>
                    ...
                    <h2 className="text-xl font-black text-white mt-3">Your Hospital is Live on the Homepage!</h2>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6 pt-6 border-t border-white/5">
                  <div className="p-3 bg-white/5 rounded-2xl">
                    ...
                    <p className="text-sm font-extrabold text-white mt-1">Spotlight Hospital</p>
                  </div>
                  <div className="p-3 bg-white/5 rounded-2xl">
                    <p className="text-[10px] text-slate-400 font-bold uppercase tracking-wider">Fee</p>
                    <p className="text-sm font-extrabold text-white mt-1">₹9,999 / month</p>
                  </div>
                  <div className="p-3 bg-white/5 rounded-2xl">
                ...
                <div className="lg:col-span-2 panel-card p-6">
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-6">
                    <div className="p-4 bg-white/5 rounded-2xl border border-white/5">
                      ...
                      <p className="text-2xl font-black text-white mt-2">2,482</p>
                      <p className="text-[10px] text-emerald-400 font-bold mt-1">↑ 18% vs yesterday</p>
                    </div>
                    <div className="p-4 bg-white/5 rounded-2xl border border-white/5">
                      <div className="flex items-center justify-between">
                      ...
                      <p className="text-2xl font-black text-white mt-2">312</p>
                      <p className="text-[10px] text-emerald-400 font-bold mt-1">↑ 12.5% CTR</p>
                    </div>
                  </div>
                  ...
                  <div className="h-44 w-full bg-white/5 rounded-2xl p-4 flex flex-col justify-between">
                    ...
                    <div className="h-28 flex items-end">
                      <svg className="w-full h-full overflow-visible" viewBox="0 0 300 100" preserveAspectRatio="none">
                        ...
                        <path d="M 0 70 Q 50 85 100 50 T 200 40 T 300 15 L 300 100 L 0 100 Z" fill="url(#chartGrad)" />
                        <path d="M 0 70 Q 50 85 100 50 T 200 40 T 300 15" fill="none" stroke="#fbbf24" strokeWidth="2.5" />
                        <circle cx="300" cy="15" r="4" fill="#fbbf24" />
                      </svg>
                    </div>
                    ...
                    >
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        {[
                          ...
                          { icon: Sparkles, title: 'Spotlight Highlights', desc: 'Premium border animations and gold spotlight accents to make your hospital stand out.' },
                      ...
                      <div className="panel-card p-6">
                        ...
                        <p className="text-xs text-slate-400 mb-4">Write a brief, high-impact tagline summarizing your hospital\'s specialties, departments, or facilities. This tagline will be displayed on the homepage spotlight.</p>
                        
                        <input
                          type="text"
                          value={tagline}
                          onChange={e => setTagline(e.target.value.slice(0, 75))}
                          placeholder="e.g. World-Class Multispeciality Care & Premier Clinical Excellence"
                        ...
                        <div className="flex justify-between items-center mt-2 text-[10px] text-slate-400">
                          <span>Recommend healthcare credentials</span>
                      ...
                      <div className="panel-card p-6 border-amber-400/30 bg-amber-400/5 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                        <div>
                          <p className="text-[9px] font-black uppercase tracking-widest text-amber-400">Premium Hospital Subscription</p>
                          <h4 className="text-base font-black text-white mt-1">Homepage Spotlight Listing</h4>
                          <p className="text-xs text-slate-400">Includes homepage featuring, premium tags, and live analytics dashboard.</p>
                        </div>
                        <div className="flex items-center gap-4 flex-shrink-0">
                          <div className="text-right">
                            <span className="text-lg font-black text-white">₹9,999</span>
                        ...
                        {paymentMethod === 'upi' && (
                          <div className="flex flex-col items-center justify-center py-2 gap-4">
                            ...
                            <div className="text-center">
                              ...
                              <p className="text-[10px] text-slate-400 mt-1">Transaction ID: TXN_DEMO_99215</p>
                            </div>
                          </div>
                        )}
                  ...
                  {step === 'success' && (
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-400 mt-1.5 max-w-sm">Congratulations! Your hospital listing has been promoted to the Spotlight section on the India Care homepage.</p>
                      </div>
                      <button
                        onClick={() => {
                          setStep('info');
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="min-w-0">
                        ...
                        <div className="flex items-center gap-2 mt-1 text-[10px] text-slate-500 font-semibold">
                          <span className="flex items-center gap-0.5"><MapPin className="w-2.5 h-2.5" /> {MOCK_HOSPITAL.city}</span>
                          <span>•</span>

...
import { getSessionToken, getSessionUser, saveSession, clearSession } from '@/lib/session';
      ...
      <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden"
        ...
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }}
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs" style={{ color: '#64748B' }}>Your registration request is currently under review by our hospital verification team.</p>
          </div>
          ...
          <div className="panel-card w-full p-4 text-left text-xs space-y-3" style={{ background: 'rgba(255,255,255,0.02)', borderColor: 'rgba(255,255,255,0.04)' }}>
            ...
            <ul className="space-y-2 text-[#94A3B8]">
              <li className="flex gap-2">⏱️ <span className="flex-1">Review usually takes <strong>48-72 business hours</strong>.</span></li>
              <li className="flex gap-2">📞 <span className="flex-1">Our onboarding team may reach out to verify license details and bed capacity.</span></li>
              <li className="flex gap-2">💳 <span className="flex-1">Once approved, you will see the subscription payment page here to unlock your hospital panel.</span></li>
            </ul>
          </div>
